...
public class RegisCombo extends JDialog {
	...
	public RegisCombo() {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(RegisCombo.class.getResource("/Imagenes/Pc-Gamer-Normal-Mode.png")));
		setModal(true);
		setResizable(false);
		...
		contentPanel.setLayout(new BorderLayout(0, 0));
		{
			...
			btnAgregar.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent arg0) {
					...
					if(q instanceof TarjetaMadre) {
						saber[1] = 1;
					}
					if(q instanceof MicroProcesador) {
						saber[2] = 1;
					}
			...
			cbxFiltro.setModel(new DefaultComboBoxModel(new String[] {"<Todos>", "Disco Duro", "Memoria Ram", "MicroProcesador", "TarjetaMadre"}));
			cbxFiltro.addActionListener(new ActionListener() {
				...
				private void loadTable(int seleccionado) {
					...
					/*
						...
						for(Combo c : Empresa.getInstance().getCombos()) {
							fila[0] = c.getCod();
							fila[1] = "Combo";
